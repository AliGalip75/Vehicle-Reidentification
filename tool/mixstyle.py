"""MixStyle by KaiyangZhou: https://github.com/KaiyangZhou/mixstyle-release"""
...
# Mixstyle açıkken çalıştır
@contextmanager
def run_with_mixstyle(model, mix=None):
    # MixStyle'ı spesifik yöntemlerle çalıştır
    if mix == 'random':
    ...
    # Varsayılan olarak MixStyle'ı etkinleştir
    try:
        model.apply(activate_mixstyle)
        yield
    finally:
