...
# Query ve gallery'deki benzersiz ID'leri kontrol edin
print(f"Query unique IDs: {len(set(query_labels))}")
print(f"Gallery unique IDs: {len(set(gallery_labels))}")

# Ortak ID'leri kontrol edin
common_ids = set(query_labels) & set(gallery_labels)
print(f"Common IDs between query and gallery: {len(common_ids)}")
